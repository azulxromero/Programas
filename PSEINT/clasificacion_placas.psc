Proceso clasificacion_placas
	//Depto de seguridad publica y transito del DF
	
	Definir n,d,amarilla,rosa,roja,verde,azul Como Entero;
	Escribir "Ingresa la cantidad de autos";
	leer n;
	amarilla = 0; rosa = 0; roja = 0; verde = 0; azul = 0;
	Mientras n > 0 Hacer
	...
	FinMientras
	Escribir "Autos con: ";
	Escribir "Calcomania amarilla ",amarilla; Escribir "Calcomania rosa ",rosa;
	Escribir "Calcomania roja ",roja; Escribir "Calcomania verde ",verde;
